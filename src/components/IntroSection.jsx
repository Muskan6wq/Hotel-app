...
function IntroSection() {
    return (
        <section className="max-w-6xl mx-auto my-10 mt-16 px-4 py-16 flex flex-col md:flex-row items-start gap-12">
            {/* LEFT: House Image */}
            ...
            <div className="w-full md:w-1/2">
                {/* Heading + Paragraph */}
                <div className="mb-6">
                    <h2 className=" md:mt-19 lg:mt-19 text-3xl md:text-4xl font-bold text-black leading-snug mb-6">
                ...
                {/* Stats */}
                <div className="flex gap-10 mt-9 lg:mt-10">
                    <div>
